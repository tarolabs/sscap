...
public:
	...
	DWORD SetIcon(int nIconIn, int nCxDesiredIn, int nCyDesiredIn, 
		int nIconOut , int nCxDesiredOut = 0, int nCyDesiredOut = 0,
		int nIconDisable = NULL, int nCxDesiredDisable = 0, int nCyDesiredDisable = 0
		);
	DWORD SetIcon(int nIconIn, int nIconOut , int nDisable );
	DWORD SetIcon(HICON hIconIn, HICON hIconOut , HICON hDisable );
...
#pragma pack()
	...
	STRUCT_ICONS	m_csIcons[3]; // 0 normal, 1 active , 2 disabled
